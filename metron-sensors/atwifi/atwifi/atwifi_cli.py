...
# AT: hacked version of pycapa example code
...
def make_parser():
    ...
    parser.add_argument('-p', '--producer',
                        help='run collector and publish to kafka',
                        dest='producer',
                        action='store_true',
                        default=False)

    parser.add_argument('-S', '--simulation',
                        help="producer that uses a Tutella db as the source as defined in config",
                        dest='simulation',
                        action='store_true',
                        default=False)
